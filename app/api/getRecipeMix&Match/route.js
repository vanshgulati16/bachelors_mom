...
export async function POST(req) {
  try {
    ...
    const prompt = `I have ${ingredients}, ${selectedSpices.join(', ')}, ${additionalSpices}. Suggest 10 dishes I can make at home quickly (within ${cookingTime}) with their recipes and sources. The cuisines is ${selectedCuisines} and the type of meal is ${selectedTypeOfMeal}, for this meal of the day ${selectedMealTime} and avoid using these ingredients ${allergies}.For each dish, provide:
      1. Dish name
      2. Brief description
